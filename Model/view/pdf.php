...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="styleres.css" href="print.css" media="print">
...
<div class="text-center mt-4">
  ...
  <button onclick="window.print();" class="btn btn-lg btn-danger" id="print-btn">Imprimer</button>
