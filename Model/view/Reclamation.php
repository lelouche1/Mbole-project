...
function getReclamationPublique(PDO $pdo){
...
function verifierOriginRE($id,$email,PDO $pdo)
{
	//$db = config::getConnexion();
...
$decla = array('Autres','Retard','Mauvais retour','Prix');
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					...
					<li ><a class="btn" href="vols.php">Vols</a></li>
					<li class="active"><a class="btn" href="Reclamation.php">Reclamation</a></li>
					<?php if(isset($user)): ?>
