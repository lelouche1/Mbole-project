        ...
        <div class="frame">
            <div class="nav">
                <ul class="links">
                    ...
                    <li class="signup-inactive"><a class="btn" href="client.php">Enregistrement</a></li>

                </ul>
            </div>
            <div ng-app ng-init="checked = false">
                <form class="form-signin" action="../Controller/code_client.php" method="post" name="form">
                    <label for="email">email</label>
                    <input class="form-styling" type="email" name="email" placeholder="" />
                    <label for="password">Mot de passe</label>
                    <input class="form-styling" type="text" name="logpassword" placeholder="" />
                    <div class="btn-animate"> 
                        <button type="submit" name="btn_login" class="btn btn-signin">connexion</button> 
                    </div>
                </form>
                <form class="form-signup" action="" method="post" name="form"> 
                    ...
                    <a ng-click="checked = !checked" class="btn-signup">Sign Up</a> </form>
