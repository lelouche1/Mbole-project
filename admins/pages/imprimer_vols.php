...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../assets/css/imprimervol.css" href="print.css" media="print">
</head>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Imprimer / Sauvegarder-PDF
            <button onclick="window.print();" class="btn btn-lg btn-success" id="print-btn">Imprimer</button>
            </h6>
        </div>
        <div class="card-body">
